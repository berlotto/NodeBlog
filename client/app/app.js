...
(function(module){
  ...
  module.config(['$routeProvider', function($routeProvider) {
    ...
    //admin routes
    $routeProvider.when('/admin', {templateUrl: 'app/partials/admin/taskList.html', controller: 'AdminTaskListCtrl', resolve: {isAuthenticated: checkAuthentication}});
    ...
    $routeProvider.when('/admin/create', {templateUrl: 'app/partials/admin/create.html', controller: 'AdminPostCreateCtrl', resolve: {isAuthenticated: checkAuthentication}});
