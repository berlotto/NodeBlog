/**
 * @license AngularJS v1.2.2-5792423
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-5792423/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-5792423',    // all of these placeholder strings will be replaced by grunt's
