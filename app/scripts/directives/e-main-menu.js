         ...
         link: function ($scope, element, attrs) {
            ...
            $(".main_menu ul li a, .goto_page_btn").click(function(e){
               ...
               if (win_width <= 991){
                  ...
                  $window.curr_page = $("div.pt-page-current").attr("id");
                  ...
                  $(".content > div#"+$window.curr_page).removeClass(anim_in_f).addClass(anim_out_f).on(animEndEventName, function(){
